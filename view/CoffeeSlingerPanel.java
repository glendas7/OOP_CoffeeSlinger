...
public class CoffeeSlingerPanel {
	...
	private void populatePictures(){
		...
		var s1 = new Snorelax(randX[0], randY[0]);
		pics.add(s1);
		s1.setImage(ImageStore.bird);
		var s2 = new Snorelax(randX[1], randY[1]);
		pics.add(s2);
		s2.setImage(ImageStore.bird);
		var s3 = new Snorelax(randX[2], randY[2]);
		pics.add(s3);
		s3.setImage(ImageStore.bird);
		var s4 = new Snorelax(randX[3], randY[3]);
		pics.add(s4);
		s4.setImage(ImageStore.bird);
	}
